                ...
                <div class="inner_wrapper">
                    <div class="container mrgTop">
                        ...
                        <div class="inner_section">
                            <div class="row">
                                <div
                                    class=" col-lg-4 col-md-4 col-sm-4 col-xs-12 pull-right"> {!!Html::image('/img/'.$page->images, '', ['class'=>"img-circle delay-03s animated wow zoomIn"]) !!}</div>
    ...
    <section class="page_section team" id="team"><!--main-section team-start-->
        <div class="container">
            ...
            <div class="team_section clearfix">
                @foreach($people as $key=>$employee)
                    <div class="team_area">
                        <div class="team_box wow fadeInDown delay-0{{$key*3 +3 }}s">
                            <div class="team_box_shadow"><a href="javascript:void(0)"></a></div>

                            {{Html::image('img/'.$employee->image, $employee->name)}}
                            <ul>
                        ...
                        <h3 class="wow fadeInDown delay-0{{$key*3 +3 }}s"> {{$employee->name}}</h3>
                        <span class="wow fadeInDown delay-0{{$key*3 +3 }}s">{{$employee->position}}</span>
                        <p class="wow fadeInDown delay-0{{$key*3 +3 }}s">{{$employee->text}}</p>
                    </div>
                    @endforeach
                ...
                <div class="col-lg-8 wow fadeInLeft delay-06s">
                    <div class="form">
                        ...
                        <input class="input-btn" type="submit" value="send message">
                            <input type="hidden" class ="input-btn" value ={{csrf_token()}} name="_token">
                            {{csrf_field()}}
                        </form>
                    </div>
                </div>
